...
exec pkg install doas vim vifm lynx git xorg neofetch scrot drm-kmod automake autoconf autotools font-awesome feh ungoogled-chromium mpv wifimgr bash zathura ubuntu-font picom audio/mixertui  x11-drivers/xf86-video-intel 
