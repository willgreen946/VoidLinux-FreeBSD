...
exec pkg install doas vim vifm lynx git xorg neofetch scrot drm-kmod font-awesome feh ungoogled-chromium mpv wifimgr bash zathura ubuntu-font picom audio/mixertui x11-fonts/nerd-fonts x11-drivers/xf86-video-intel 
