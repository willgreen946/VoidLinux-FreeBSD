...
exec pkg install doas vim vifm lynx git xorg neofetch firefox scrot feh mpv wifimgr bash zathura ubuntu-font picom audio/mixertui x11-drivers/xf86-video-intel 
